            ...
            <form wire:submit="simpanPelunasan" class="mt-3 pt-3 border-t border-slate-100 space-y-2">
                <div class="flex gap-2">
                    <input type="number" step="0.01" min="0" wire:model="jumlahPelunasan"
                        class="flex-1 rounded-lg border border-slate-300 px-3 py-2 text-sm transition-colors focus:border-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-900/10">
                    <input type="date" wire:model="tanggalPelunasan"
                        class="rounded-lg border border-slate-300 px-3 py-2 text-sm transition-colors focus:border-slate-500 focus:outline-none focus:ring-2 focus:ring-slate-900/10">
                </div>
