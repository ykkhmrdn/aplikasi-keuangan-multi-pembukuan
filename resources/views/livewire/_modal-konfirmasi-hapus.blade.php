...
>
    <div class="w-full max-w-sm rounded-xl bg-white p-5 shadow-xl shadow-slate-900/10">
        ...
        <div class="mt-5 flex gap-2">
            <button
                ...
                class="min-h-11 flex-1 rounded-lg border border-red-200 bg-red-50 px-4 text-sm font-semibold text-red-700 transition-colors hover:bg-red-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-red-600/30 motion-safe:active:scale-[0.97]"
            >
                Ya, Hapus
            </button>
            <button
                ...
                class="min-h-11 flex-1 rounded-lg border border-slate-200 px-4 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-50 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-blue-600/20 motion-safe:active:scale-[0.97]"
            >
                Batal
            </button>
        </div>
